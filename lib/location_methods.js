var sort_distances = function (distances, locations) {
	distances.sort(function(a, b) {return a.duration - b.duration;});
	console.log(distances);
}

var async = function(locations, callback, i, current_location, distances) {
...
var get_choice = function(locations, current_location) {
	...
	for (var i = 0; i < locations.length; i++) {
		async(locations, get_distance, i, current_location, distances);
	}
}
...
var gd = function(locations, current_location, distances, i) {
	...
	function(err, data) {
		...
		// my_obj = {"duration" : data.durationValue, "index" : i}
...
// var get_distance = function ( i, locations, current_location, distances) {
...
// 		if (err) return console.log(err);
// 		my_obj = {"duration" : data.durationValue, "index" : i}
// 		distances.push(my_obj);

// 		if (i+1 < locations.length) {
// 			get_distance(i+1, locations, current_location, distances);
// 		}
// 		else {
// 			console.log(distances);
// 			sort_distances(distances, locations);
// 		}
// 	});
// }
